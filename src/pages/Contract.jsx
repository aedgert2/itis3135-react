export default function Contract() {
  return (
    <main>
      ...
      <p>
        I, Andrew J Edgerton, agree to abide by the terms of the course contract
        in my Fall 2025, ITIS 3135, Web-Based Application Design and Development
        with my instructor, Professor D.I. von Briesen.
      </p>
      ...
      <p>
        ...
        is inappropriate for schoolwork, or that I wish to keep private.
      </p>
      ...
      <p>
        I also understand that given the structure and content of this class
